...
The Rust SDK's https://docs.rs/couchbase/latest/couchbase/collection_ds/index.html[`collection_ds`] contains four data structures that provide high-level data structure abstractions.
These also support sub-document operations.:
