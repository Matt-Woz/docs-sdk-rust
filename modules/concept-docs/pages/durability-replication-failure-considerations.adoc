...
This page covers the durability options offered by Couchbase Server, with the rest of this section covering logging, health check, and observability --
...
// We don't support txns in rust yet so it seems a bit odd to include this.
