...
The Rust SDK exposes an API for performing search queries which abstracts some of the complexity of using the underlying REST API.
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=imports,indent=0]
----
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=basicsearch,indent=0]
----
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=handlingresults,indent=0]
----
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=consistency,indent=0]
----
