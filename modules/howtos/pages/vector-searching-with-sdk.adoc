...
// 
// It can be seen built at https://docs.couchbase.com/rust-sdk/1.0/howtos/vector-searching-with-sdk.html
...
[source,rust]
----
include::devguide:example$src/queries.rs[tag=hyperscale,indent=2]
----
...
[source,java]
----
include::devguide:example$src/queries.rs[tag=parameterizedvectorquery,indent=2]
----
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=vectorsearch,indent=0]
----
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=multiplevectors,indent=0]
----
...
[source,rust]
----
include::devguide:example$src/search.rs[tag=combinesearchvector,indent=0]
----
...
* Vector Search in the https://docs.rs/couchbase/latest/couchbase/search/request/struct.SearchRequest.html#method.vector_search[Rust API reference].
