...
[source,go]
----
include::devguide:example$go/Metrics.go[tag=metrics-enable-custom,indent=0]
----
...
[source,go]
----
include::devguide:example$go/Metrics.go[tag=metrics-otel-prometheus,indent=0]
----
...
[source,go]
----
include::devguide:example$go/MetricsMicrometer.go[tag=metrics-micrometer-prometheus,indent=0]
----
