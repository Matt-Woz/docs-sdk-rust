...
All being well, `opentelemetry-collector` should regularly log that it's receiving the `db.client.operations` metric, as it has been configured with a `debug` exporter.
