...
If you are changing the retry strategy of individual requests keep the semantics discussed in <<#idempotent-and-non-idempotent-operations,Idempotent vs. Non-Idempotent Requests>> in mind.
...
Diagnostic methods are available to check on the xref:health-check.adoc[health of the cluster], and the xref:observability-tracing.adoc[health of the network].
