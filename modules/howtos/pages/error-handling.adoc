...
[source,go]
----
include::devguide:example$go/ErrorHandling.go[tag=customglobal,indent=0]
----
...
[source,go]
----
include::devguide:example$go/ErrorHandling.go[tag=customreq,indent=0]
----
...
[source,go]
----
include::devguide:example$go/ErrorHandling.go[tag=customclass,indent=0]
----
...
[source,go]
----
include::devguide:example$go/ErrorHandling.go[tag=failfastcircuit,indent=0]
----
