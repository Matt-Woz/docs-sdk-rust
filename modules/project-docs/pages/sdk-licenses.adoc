...
see https://github.com/couchbase/docs-sdk-rust/blob/release/{sdk_dot_minor}/LICENSE[https://github.com/couchbase/docs-sdk-rust/blob/release/{sdk_dot_minor}/LICENSE].
