...
This repository hosts the documentation source for the https://docs.couchbase.com/rust-sdk/1.0/hello-world/overview.html[Couchbase Rust SDK].

This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/rust-sdk/1.0/project-docs/compatibility.html#api-version[SDK 3.8 API].
...
* antora.yml
* build.gradle
* modules/devguide/examples/rust/pom.xml
